/**
 * AI Style Transfer - Tool #031
 * Awesome AI Local Tools
 *
 * Simulated Style Transfer using Arbitrary Style Transfer concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Arbitrary Style Transfer 模型，將照片轉換為藝術風格。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Arbitrary Style Transfer model to apply artistic styles to photos.',
        privacy: 'Privacy',
