/**
 * AI Moire Removal - Tool #028
 * Awesome AI Local Tools
 *
 * Simulated Moire Removal using Moire Removal Net concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Moire Removal Net 模型，消除螢幕翻拍產生的摩爾紋。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Moire Removal Net to remove moire patterns.',
        privacy: 'Privacy',
