/**
 * AI Super Resolution 2x - Lightweight Image Upscaling
 * Tool #012 - Uses ESRGAN-inspired upscaling with Transformers.js
 */
...
const translations = {
    zh: {
        title: 'AI 超解析度 2x',
        subtitle: '輕量級 AI 放大，將圖片解析度提升 2 倍，速度更快',
        privacyBadge: '100% 本地處理 · 零資料上傳',
        loadingModel: '正在載入 AI 模型...',
        loadingHint: '首次載入需下載約 16 MB 模型檔案',
        uploadText: '點擊或拖放圖片到這裡',
        uploadHint: '支援 JPG、PNG、WebP 格式（建議不超過 1024x1024）',
        original: '原圖',
        result: '放大結果',
        processingInfo: '處理資訊',
        inputSize: '輸入尺寸',
        ...
        step2Title: '深度學習重建',
        step2Desc: '使用 ESRGAN 模型智慧補充像素細節',
        step3Title: '細節增強',
        step3Desc: '銳化邊緣、還原紋理，提升整體清晰度',
        step4Title: '2 倍放大',
        step4Desc: '輸出解析度提升為原圖的 4 倍像素',
        techSpecs: '技術規格',
        specModel: 'AI 模型',
        specScale: '放大倍率',
        specInput: '輸入格式',
    ...
    en: {
        title: 'AI Super Resolution 2x',
        subtitle: 'Lightweight AI upscaling, 2x resolution enhancement, faster processing',
        privacyBadge: '100% Local Processing · Zero Data Upload',
        loadingModel: 'Loading AI Model...',
        loadingHint: 'First load requires ~16 MB model download',
        uploadText: 'Click or drag and drop image here',
        uploadHint: 'Supports JPG, PNG, WebP (recommended max 1024x1024)',
        original: 'Original',
        ...
        step2Desc: 'ESRGAN model intelligently fills in pixel details',
        step3Title: 'Detail Enhancement',
        step3Desc: 'Sharpen edges, restore textures, improve clarity',
        step4Title: '2x Upscaling',
        step4Desc: 'Output resolution is 4x the original pixels',
...
async function loadModel() {
    try {
        ...
        // Using a lightweight model suitable for 2x upscaling
...
async function processImage() {
    ...
    const maxSize = 512; // Limit for 2x model performance
    ...
    try {
        ...
        if (upscaler) {
            ...
            // Fallback: Enhanced bicubic upscaling
            resultWidth = width * 2;
...
function downloadResult() {
    ...
    link.download = 'super-resolution-2x.png';
