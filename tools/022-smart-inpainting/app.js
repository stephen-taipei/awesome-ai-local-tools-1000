/**
 * Smart Inpainting - Tool #022
 * Simple Inpainting using a basic algorithm for the demo.
 * Ideally this should use MAT or a similar ONNX model.
...
const translations = {
    ...
    'en': {
        ...
        subtitle: 'Repair damaged or missing areas in images',
...
function processRemoval() {
    ...
    setTimeout(() => {
        ...
        newImg.onload = () => {
            image = newImg;
            render();
            elements.processBtn.textContent = translations[currentLang].repairImage;
