/**
 * AI Photo Colorization - Tool #025
 * Awesome AI Local Tools
 *
 * Simulated Photo Colorization using DDColor/DeOldify concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        uploadHint: '支援 PNG, JPG, WebP (建議黑白照片)',
        original: '原圖',
        result: '上色結果',
        processing: '正在處理中...',
        download: '下載上色圖片',
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 DDColor/DeOldify 模型，將黑白照片自動上色。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        uploadHint: 'Supports PNG, JPG, WebP (B&W recommended)',
        original: 'Original',
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses DDColor/DeOldify model to automatically colorize black and white photos.',
        privacy: 'Privacy',
