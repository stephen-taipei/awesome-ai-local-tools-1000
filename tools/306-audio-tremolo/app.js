/**
 * Audio Tremolo - Tool #306
 * Add tremolo (volume modulation) effect to audio
 */
...
const texts = {
    ...
    en: {
        title: 'Tremolo',
        subtitle: 'Add volume modulation effect to audio',
...
async function processAudio() {
    ...
    for (let ch = 0; ch < channels; ch++) {
        ...
        for (let i = 0; i < length; i++) {
            ...
            const modulation = 1 - depth * (0.5 + 0.5 * generateWave(waveType, phase));

            const wetSample = inputData[i] * modulation;
