/**
 * AI Red Eye Removal - Tool #027
 * Awesome AI Local Tools
 *
 * Simulated Red Eye Removal using Eye Detection + Color Correction concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Eye Detection + Color Correction 模型，自動偵測並消除紅眼。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Eye Detection + Color Correction model to remove red eyes.',
        privacy: 'Privacy',
