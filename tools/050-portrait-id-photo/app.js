/**
 * AI Portrait ID Photo - Tool #050
 * Awesome AI Local Tools
 *
 * Create professional ID photos with auto-crop and standard background colors
...
const translations = {
    ...
    'en': {
        title: 'AI Portrait ID Photo',
        subtitle: 'One-click standard ID photo generation',
