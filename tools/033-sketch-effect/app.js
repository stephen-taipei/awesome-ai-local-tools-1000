/**
 * AI Sketch Effect - Tool #033
 * Awesome AI Local Tools
 *
 * Simulated Sketch Effect using Pencil Sketch Net concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Pencil Sketch Net 模型，將照片轉換為素描風格。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Pencil Sketch Net to convert photos to sketches.',
        privacy: 'Privacy',
