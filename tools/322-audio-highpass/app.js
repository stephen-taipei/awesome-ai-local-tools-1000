/**
 * Audio High-Pass Filter - Tool #322
...
const texts = {
    ...
    en: {
        ...
        subtitle: 'Remove low frequency rumble and noise',
...
// High-pass filter coefficients (biquad)
function calculateHighPassCoeffs(sampleRate, cutoff, Q) {
...
async function processAudio() {
    ...
    const coeffs = calculateHighPassCoeffs(sampleRate, cutoff, Q);
