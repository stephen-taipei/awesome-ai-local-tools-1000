/**
 * AI Text Removal - Tool #029
 * Awesome AI Local Tools
 *
 * Simulated Text Removal using Text Detection + LaMa concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Text Detection + LaMa 模型，偵測並移除圖片中的文字。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Text Detection + LaMa model to remove text from images.',
        privacy: 'Privacy',
