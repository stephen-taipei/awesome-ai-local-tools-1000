/**
 * Watermark Removal - Tool #023
 * Specialized Inpainting for watermark removal.
 * Ideally this should use a specific Watermark Removal Network (ONNX).
...
const translations = {
    ...
    'en': {
        ...
        subtitle: 'Automatically detect and remove image watermarks',
...
function processRemoval() {
    ...
    setTimeout(() => {
        ...
        newImg.onload = () => {
            image = newImg;
            render();
            elements.processBtn.textContent = translations[currentLang].removeWatermark;
