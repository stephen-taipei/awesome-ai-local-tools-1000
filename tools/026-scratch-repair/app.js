/**
 * AI Scratch Repair - Tool #026
 * Awesome AI Local Tools
 *
 * Simulated Scratch Repair using Scratch Detection + LaMa concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 Scratch Detection + LaMa 模型，自動偵測並修復刮痕。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        aiModel: 'AI Model',
        aiModelDesc: 'Uses Scratch Detection + LaMa model to automatically remove scratches.',
        privacy: 'Privacy',
