/**
 * AI Cartoonizer - Tool #032
 * Awesome AI Local Tools
 *
 * Simulated Cartoonizer using AnimeGAN/CartoonGAN concept.
 */
...
const translations = {
    'zh-TW': {
        ...
        howItWorks: '如何運作？',
        aiModel: 'AI 模型',
        aiModelDesc: '使用 AnimeGAN/CartoonGAN 模型，將照片轉換為動漫/卡通風格。',
        privacy: '隱私保護',
    ...
    'en': {
        ...
        original: 'Original',
        result: 'Cartoonized Result',
        processing: 'Processing...',
        download: 'Download Result',
        uploadAnother: 'Upload Another',
        howItWorks: 'How It Works',
        aiModel: 'AI Model',
        aiModelDesc: 'Uses AnimeGAN/CartoonGAN model to convert photos to cartoon style.',
        privacy: 'Privacy',
